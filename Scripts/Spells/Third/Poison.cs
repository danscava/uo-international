		...
		public void Target( Mobile m )
		{
			...
			else if ( CheckHSequence( m ) )
			{
				...
				else
				{
					...
					{
						int spec_tot = (Caster.Skills.Magery.Fixed + Caster.Skills.Poisoning.Fixed + Caster.Skills.Meditation.Fixed + Caster.Skills.EvalInt.Fixed + Caster.Skills.MagicResist.Fixed + Caster.Skills.Inscribe.Fixed) / 6;
