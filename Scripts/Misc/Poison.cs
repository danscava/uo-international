...
namespace Server
{
	public class PoisonImpl : Poison
	{
		...
		public static void Configure()
		{
			...
			{
				Register( new PoisonImpl( "Lesser",		0, 4, 15,  2.500, 3.5, 3.0, 10, 2 ) );
				Register( new PoisonImpl( "Regular",	1, 5, 15,  3.125, 3.5, 3.0, 10, 2 ) );
				Register( new PoisonImpl( "Greater",	2, 6, 15,  6.250, 3.5, 3.0, 10, 2 ) );
				Register( new PoisonImpl( "Deadly",		3, 7, 15, 12.500, 3.5, 4.0, 10, 2 ) );
